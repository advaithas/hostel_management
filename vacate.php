...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Vacate Hostel </h2>
			<div class="mail_grid_w3l">
            <form action="includes/vacate.inc.php" method="POST">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="Student_id" placeholder="Roll Number" value="<?php echo $_SESSION['roll']; ?>" required="">
							</div>
                            <input type="submit" name="vacate-submit" value="Vacate">
						</div>

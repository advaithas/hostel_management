        ...
        <form action="includes/signup.inc.php" method="POST">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="Student_id" placeholder="SRN" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    <i class="fas fa-phone"></i>
                    <input type="text" class="form-control" name="ContactNo" placeholder="Contact No" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="Semester" placeholder="Semester" required="required" />
                </div>
            </div>
          ...
          <!--  <div class=" w3l-form-group">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    <i class="fas fa-unlock"></i>
                    <input type="password" class="form-control" name="confirmPasswd" placeholder="Confirm Password" required="required" />
                </div>
            </div>
            <!--<div class="forgot">

...
<head>
    <title>PES Hostel Management</title>
    <!-- meta tags -->
    <meta charset="UTF-8" />
...
<body style="background-color: #730f17;">
    <img width="200px" height="120px" src="peslogo.png" alt="" style="width: 225px !important; height: 100px !important; padding-left: 605px !important;" >
        ...
        <form action="includes/login.inc.php" method="POST">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="Student_id" placeholder="Roll No" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
